...
public class CameraUtils implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        // CORREÇÃO: ResourceLocation.fromNamespaceAndPath trocado por Identifier.of
        CATEGORY_CAMERAUTILS = KeyMapping.Category.register(Identifier.of(MODID, "camerautils"));
        CATEGORY_CAMERAUTILS_SETTINGS = KeyMapping.Category.register(Identifier.of(MODID, "camerautils_settings"));
